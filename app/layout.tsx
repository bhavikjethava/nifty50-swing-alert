...
import { Activity, BellRing, FlaskConical, LineChart, Target, Wallet } from "lucide-react";
import "./globals.css";
          ...
          <header className="sticky top-0 z-20 border-b bg-background/90 backdrop-blur">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
              ...
              <nav className="flex items-center gap-2">
                ...
                <Link className="hidden items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-secondary sm:flex" href="/portfolio">
